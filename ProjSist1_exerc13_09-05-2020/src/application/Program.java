...
import model.entities.DoubleArrayList;
import java.util.ArrayList;
import java.util.Scanner;
import model.exceptions.DomainException;
import model.util.ArrayListTypeConverter;
    ...
    public static void main(String[] args) {
        ...
        try{
            do {
                ...
                ArrayListTypeConverter.ConvtStrNmbsToIntNmbs(numericPhrase, convertedIntegerNumbers); //Integer Parsed ArrayList
                if(l == 0) {
